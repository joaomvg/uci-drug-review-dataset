...
def model_fn(model_dir):
    ...
    model = Classifier1L(model_info['embedding_dim'], model_info['vocab_size'],model_info['hidden_dim'], model_info['output_dim'])
...
if __name__ == '__main__':
    ...
    # Build the model.
    model = Classifier1L(args.embedding_dim,args.vocab_size, args.hidden_dim,args.output_dim).to(device)
