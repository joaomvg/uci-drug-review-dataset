...
from model_ffn import Classifier2L, csr_to_torch_float, y_torch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden1_dim', type=int, default=100, metavar='N',
                        help='size of the hidden dimension (default: 100)')
    parser.add_argument('--hidden2_dim', type=int, default=100, metavar='N',
                        help='size of the hidden dimension (default: 100)')
    ...
    # Build the model.
    model = Classifier2L(args.vocab_size, args.hidden1_dim,args.hidden2_dim,args.output_dim,args.drop_rate).to(device)

    print("Model loaded with hidden1_dim {},hidden2_dim {}, vocab_size {}, output_dim {}, dropout rate {}".format( args.hidden1_dim,args.hidden2_dim, args.vocab_size, args.output_dim, args.drop_rate))
